  ...
  return (
    <div ref={wrapperRef} className="relative flex">
      ...
      {open && (
        <div
          role="menu"
          className="absolute z-50 top-full mt-2 right-0 min-w-[200px] bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-white/10 rounded-md shadow-[0_0_28px_-4px_rgb(0_0_0_/_0.12)] dark:shadow-[0_0_28px_-4px_rgb(0_0_0_/_0.5)] p-1 overflow-y-auto overscroll-contain max-h-[70vh] anim-scale-in"
