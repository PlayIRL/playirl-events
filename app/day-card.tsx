        ...
        {events.map((ev, i) => {
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className={`inline-block px-2 py-0.5 rounded-sm text-[11px] font-black mb-1 tracking-wide font-[family-name:var(--font-card-title)] ${FORMAT_BADGE[ev.format] || FORMAT_BADGE_DEFAULT}`}>
                  {ev.format}
                </span>
