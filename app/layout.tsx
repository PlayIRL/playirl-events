...
export const viewport: Viewport = {
  ...
  initialScale: 1,
  viewportFit: "cover",
  // Stay on the default `resizes-visual` — `resizes-content` was
  // inconsistent across iOS versions (some left a huge gap above the
  // URL bar). The FloatingToolbar now tracks `window.visualViewport`
  // directly and adjusts its own offset, which is reliable everywhere.
  themeColor: [
