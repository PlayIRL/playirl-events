...
export default function ShareButton({ title, url }: { title: string; url: string }) {
  ...
  return (
    <div ref={triggerRef} className="relative">
      {/* Primary fill so the Share CTA pops next to the "Add to calendar"
          button — sharing the event link is the dominant action we want
          a viewer to take. Sized to match the calendar button next to it
          (both h-9 px-4 text-sm) so they read as a paired action group. */}
