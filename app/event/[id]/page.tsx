    ...
    <main className="w-full max-w-2xl min-w-0 mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6 anim-fade-in">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-1.5 h-7 px-3 rounded-md bg-neutral-100 dark:bg-white/5 border border-neutral-100 dark:border-white/8 shadow-sm text-neutral-700 dark:text-neutral-300 text-xs font-medium hover:bg-neutral-200 dark:hover:bg-white/10 hover:text-neutral-900 dark:hover:text-white transition"
      ...
      <div className="bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-white/8 rounded-md anim-fade-in-up" style={{ "--delay": "60ms" } as React.CSSProperties}>
        ...
        <div className="p-6 pb-4 space-y-3 rounded-t-md border-b border-neutral-100 dark:border-white/8">
          ...
          <span className={`inline-block px-3 py-1 rounded-sm text-xs font-bold tracking-widest uppercase font-[family-name:var(--font-card-title)] ${FORMAT_BADGE[ev.format] || FORMAT_BADGE_DEFAULT}`}>
            {ev.format || "MTG"}
          </span>
          <h1 className="text-3xl sm:text-4xl font-[family-name:var(--font-ultra)] font-bold text-neutral-900 dark:text-white break-words leading-tight tracking-widest">{ev.title}</h1>
        </div>
