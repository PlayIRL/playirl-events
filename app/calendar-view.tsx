                    ...
                    dayEvents.map((ev) => {
                      ...
                      >
                        <div className="flex flex-col gap-px">
                          ...
                          <div>
                            <span className={`px-1.5 py-0.5 rounded-sm text-[11px] font-black tracking-wide font-[family-name:var(--font-card-title)] ${FORMAT_BADGE[ev.format] || FORMAT_BADGE_DEFAULT}`}>
                              {ev.format}
                            </span>
                          </div>
                        </div>
