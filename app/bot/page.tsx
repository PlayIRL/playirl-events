        ...
        <div className="mb-8">
          {inviteUrl ? (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-md bg-neutral-100 text-neutral-900 dark:bg-neutral-800 dark:text-white font-semibold text-base hover:bg-neutral-200 dark:hover:bg-neutral-700 transition shadow-sm cursor-pointer"
            >
