...
const VARIANTS = {
  ...
  primary: "inline-flex items-center justify-center gap-2 h-9 px-4 rounded-md bg-neutral-100 text-neutral-900 hover:bg-neutral-200 dark:bg-neutral-800 dark:text-white dark:hover:bg-neutral-700 text-sm font-medium disabled:opacity-50 transition cursor-pointer",
