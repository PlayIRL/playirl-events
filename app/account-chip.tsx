...
const PILL = "fixed top-[var(--chip-top,1rem)] right-4 transition-[top] duration-300 z-40 flex bg-white dark:bg-neutral-900 rounded-full p-0.5 border border-neutral-200 dark:border-white/15 shadow-xl shadow-black/15 dark:shadow-black/50";
