...
const EN: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "cEDH only",
    cedh_only_help: "Competitive EDH — high-stakes Commander events.",
...
const FR: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "cEDH uniquement",
    cedh_only_help: "Competitive EDH — événements Commander à enjeux élevés.",
...
const DE: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "Nur cEDH",
    cedh_only_help: "Competitive EDH — hochkarätige Commander-Turniere.",
...
const ES: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "Solo cEDH",
    cedh_only_help: "Competitive EDH — eventos de Commander competitivos.",
...
const IT: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "Solo cEDH",
    cedh_only_help: "Competitive EDH — eventi Commander ad alto livello.",
...
const NL: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "Alleen cEDH",
    cedh_only_help: "Competitive EDH — competitieve Commander-evenementen.",
...
const JA: StringTree = {
  ...
  filters: {
    ...
    cedh_only_label: "cEDH のみ",
    cedh_only_help: "Competitive EDH — ハイレベル統率者戦イベント。",
